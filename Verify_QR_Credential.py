...
class QR_data():
    ...
    def verify_signature(self, cert):
        cert_verify = OpenSSL.crypto.verify(cert, self.cert_sign_bytes, self.raw_verify_bytes, 'sha256')
...
def main():
    signer_cert_filename = 'OpenSSLKeys/harry_cert.pem'
    qr_code_filename = 'chris_qr.png'

    # Load certificate key for verifying user data
